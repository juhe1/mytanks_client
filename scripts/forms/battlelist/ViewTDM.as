package forms.battlelist
{
   ...
   public class ViewTDM extends Sprite
   {
      ...
      public function updatePlayer(team:Boolean = true, id:Object = null, name:String = "", rang:int = 0, kills:int = 0) : void
      {
         ...
         this.fightButtonRed.enable = !!this._available ? Boolean(this.countRed <= this.countBlue || !this._autoBalance) : Boolean(false);
         this.fightButtonBlue.enable = !!this._available ? Boolean(this.countBlue <= this.countRed || !this._autoBalance) : Boolean(false);
      ...
      public function removePlayer(id:Object) : void
      {
         ...
         this.fightButtonRed.enable = !!this._available ? Boolean(this.countRed - this.countBlue < 2) : Boolean(false);
         this.fightButtonBlue.enable = !!this._available ? Boolean(this.countBlue - this.countRed < 2) : Boolean(false);
         if(this.delayTimer == null)
         {
            this.delayTimer = new Timer(500,1);
            this.delayTimer.addEventListener(TimerEvent.TIMER,this.resizeList);
