...
[Embed(source="890.png")]
      ...
      public function objectLoaded(clientObject:ClientObject) : void
      {
         ...
         this.mainExplosionSequence = this.getExplosionMaterialSequence(initParams.mainExplosionTextureId,MAIN_EXPLOSION_FRAME_WIDTH,1,resourceService,this.mainExplosionFrameSize);
         this.idleExplosionSequence = this.getExplosionMaterialSequence(initParams.idleExplosionTextureId,IDLE_EXPLOSION_FRAME_WIDTH,1,resourceService,this.idleExplosionFrameSize);
         this.redMineMaterial = this.getTextureMaterial(initParams.redMineTextureId,1,resourceService);
         this.blueMineMaterial = this.getTextureMaterial(initParams.blueMineTextureId,1,resourceService);
         this.friendlyMineMaterial = this.getTextureMaterial(initParams.friendlyMineTextureId,1,resourceService);
