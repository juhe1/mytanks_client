package alternativa.physics.collision.types
{
   public class BoundBox
   {
      ...
      {
         this.minX = boundBox.minX < this.minX ? Number(Number(boundBox.minX)) : Number(Number(this.minX));
         this.minY = boundBox.minY < this.minY ? Number(Number(boundBox.minY)) : Number(Number(this.minY));
         this.minZ = boundBox.minZ < this.minZ ? Number(Number(boundBox.minZ)) : Number(Number(this.minZ));
         this.maxX = boundBox.maxX > this.maxX ? Number(Number(boundBox.maxX)) : Number(Number(this.maxX));
         this.maxY = boundBox.maxY > this.maxY ? Number(Number(boundBox.maxY)) : Number(Number(this.maxY));
         this.maxZ = boundBox.maxZ > this.maxZ ? Number(Number(boundBox.maxZ)) : Number(Number(this.maxZ));
      }
