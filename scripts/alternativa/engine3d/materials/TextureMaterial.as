package alternativa.engine3d.materials
{
   ...
   public class TextureMaterial extends Material
   {
      ...
      public function TextureMaterial(bitmapData:BitmapData = null, repeat:Boolean = false, smooth:Boolean = true, mipMapping:int = 0, resolution:Number = 1)
      {
         ...
         if(bitmapData != null)
         {
            ...
            this.textureResource = TextureResourcesRegistry.getTextureResource(bitmapData,this._mipMapping > 0,repeat,this._hardwareMipMaps);
         }
      }
      ...
      public function getTextureResource() : BitmapTextureResource
      {
