      ...
      override alternativa3d function draw(param1:Camera3D) : void
      {
            ...
            if(_loc20_.left.distance != _loc20_.right.distance)
            {
               ...
               if(culling > 0)
               {
                  ...
                  if(_loc18_ > -_loc16_ && _loc15_ <= -_loc13_)
                  {
                     ...
                     _loc13_ += (_loc16_ - _loc13_) * _loc19_;
                     _loc14_ += (_loc17_ - _loc14_) * _loc19_;
                     _loc15_ += (_loc18_ - _loc15_) * _loc19_;
                  }
         ...
         if(_loc6_ != null)
         {
            if(this.minSize > 0)
            {
               ...
               while(_loc11_ != null)
               {
                  _loc23_ += (_loc11_.u - _loc15_) * (_loc11_.y - _loc18_) - (_loc11_.v - _loc18_) * (_loc11_.x - _loc15_);
