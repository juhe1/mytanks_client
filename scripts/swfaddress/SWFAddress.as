package swfaddress
{
   ...
   public class SWFAddress
   {
      ...
      public static function getStrict() : Boolean
      {
         ...
         return strict == null ? Boolean(Boolean(_strict)) : Boolean(Boolean(strict == "true"));
      }
      ...
      {
         return !!_availability ? Boolean(Boolean(ExternalInterface.call("SWFAddress.getHistory") as Boolean)) : Boolean(Boolean(false));
      }
